    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center px-6">
        <div style={{ textAlign: "center", maxWidth: 400 }}>
          ...
          <h2 style={{ color: "#fff", fontFamily: "'Syne', sans-serif", fontWeight: 900, fontSize: 28, marginBottom: 12 }}>Welcome to Kravely!</h2>
          <p style={{ color: "#6b7280", fontFamily: "'DM Sans', sans-serif", fontSize: 15, lineHeight: 1.7 }}>
            Your account has been created. Taking you to the app...
          </p>
          <div style={{ marginTop: 24, width: "100%", height: 3, background: "rgba(255,255,255,0.1)", borderRadius: 2, overflow: "hidden" }}>
            <div style={{ height: "100%", width: "100%", background: "#22c55e", borderRadius: 2, animation: "progress 2s linear forwards" }} />
          </div>
  ...
  return (
    <>
      <style>{`
        ...
        .input-field { width: 100%; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 15px 18px; color: #fff; font-size: 15px; font-family: 'DM Sans', sans-serif; outline: none; transition: all 0.2s ease; box-sizing: border-box; }
        .input-field:focus { border-color: rgba(34,197,94,0.5); background: rgba(34,197,94,0.04); box-shadow: 0 0 0 3px rgba(34,197,94,0.08); }
        .input-field::placeholder { color: rgba(255,255,255,0.2); }
        .signup-btn { width: 100%; background: #22c55e; color: #000; font-weight: 800; font-size: 16px; font-family: 'DM Sans', sans-serif; padding: 16px; border-radius: 14px; border: none; cursor: pointer; transition: all 0.25s ease; }
        .signup-btn:hover:not(:disabled) { background: #16a34a; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(34,197,94,0.3); }
        .signup-btn:disabled { opacity: 0.6; cursor: not-allowed; }
        .shimmer-logo { background: linear-gradient(90deg, #22c55e, #4ade80, #22c55e); background-size: 200% auto; -webkit-background-clip: text; -webkit-text-fill-color: transparent; animation: shimmer 3s linear infinite; }
        .social-btn { width: 100%; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 13px; color: #fff; font-size: 14px; font-family: 'DM Sans', sans-serif; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.2s ease; }
      ...
      <div className="min-h-screen bg-black flex">
        ...
        {/* LEFT — Visual */}
        <div className="hidden lg:flex flex-1 relative overflow-hidden items-center justify-center" style={{ background: "#050505", borderRight: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 relative overflow-y-auto">
          <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 70% 50%, rgba(34,197,94,0.05) 0%, transparent 60%)" }} />
          ...
          <div className="relative z-10 w-full max-w-md signup-anim">
            ...
            {/* Google */}
            <button className="social-btn mb-5" onClick={handleGoogle}>
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-4 mb-5">
                ...
                <div>
                  <label className="block text-gray-400 text-xs font-semibold mb-2 uppercase tracking-wider" style={{ fontFamily: "'DM Sans', sans-serif" }}>Full Name</label>
                  <input className="input-field" type="text" name="fullName" value={form.fullName} onChange={handleChange} placeholder="e.g. Ebuka Okolo" required />
                </div>

                <div>
                  <label className="block text-gray-400 text-xs font-semibold mb-2 uppercase tracking-wider" style={{ fontFamily: "'DM Sans', sans-serif" }}>Email Address</label>
                ...
                <div>
                  <label className="block text-gray-400 text-xs font-semibold mb-2 uppercase tracking-wider" style={{ fontFamily: "'DM Sans', sans-serif" }}>Phone Number</label>
                  <input className="input-field" type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="080XXXXXXXX" required />
                </div>
                ...
                <div>
                  ...
                  {strength && (
                    <div className="mt-2">
                      ...
                      <p style={{ color: strength.color, fontSize: 11, fontFamily: "'DM Sans', sans-serif", marginTop: 4 }}>{strength.label}</p>
                    </div>
                  )}
                </div>

                <div>
                  <label className="block text-gray-400 text-xs font-semibold mb-2 uppercase tracking-wider" style={{ fontFamily: "'DM Sans', sans-serif" }}>Confirm Password</label>
                  <input className="input-field" type="password" name="confirmPassword" value={form.confirmPassword} onChange={handleChange} placeholder="Repeat your password" required
                    style={{ borderColor: form.confirmPassword && form.password !== form.confirmPassword ? "rgba(239,68,68,0.5)" : "" }} />
                  {form.confirmPassword && form.password !== form.confirmPassword && (
                    <p style={{ color: "#ef4444", fontSize: 11, fontFamily: "'DM Sans', sans-serif", marginTop: 4 }}>Passwords don't match</p>
                  )}
                </div>
